...
| `FREE_DATABASE_URL`                       | GitHub secret                            | external backend Postgres runtime such as Supabase                       | [free-first-deployment.md](/Users/yazan/Documents/Gazelle/Dev/GazelleMobilePlatform/docs/runbooks/free-first-deployment.md)                           |
| `FREE_POSTGRES_PASSWORD`                  | GitHub secret                            | bundled Droplet Postgres fallback runtime                                | [free-first-deployment.md](/Users/yazan/Documents/Gazelle/Dev/GazelleMobilePlatform/docs/runbooks/free-first-deployment.md)                           |

...
- the current release tag exists on `main`
...
- versioning, GitHub release tagging, and `dev` to `main` process flow
...
1. Confirm the release candidate on `main`.
   Use the current merged `main` state and its semantic-version tag from [versioning.md](/Users/yazan/Documents/Gazelle/Dev/GazelleMobilePlatform/docs/runbooks/versioning.md).
...
3. Publish backend images to `GHCR`.
   Trigger `publish-free-images`, capture the chosen image tag, and freeze that tag for deploy.
...
| `FREE_IMAGE_TAG`                          | GitHub variable                          | optional manual backend image override for rollback or explicit redeploy | [free-first-deployment.md](/Users/yazan/Documents/Gazelle/Dev/GazelleMobilePlatform/docs/runbooks/free-first-deployment.md)                           |
| `FREE_POSTGRES_PASSWORD`                  | GitHub secret                            | backend Postgres runtime                                                 | [free-first-deployment.md](/Users/yazan/Documents/Gazelle/Dev/GazelleMobilePlatform/docs/runbooks/free-first-deployment.md)                           |

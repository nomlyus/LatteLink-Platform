...
- Passkey endpoints now enforce real WebAuthn verification (challenge + credential proof); demo/manual payload entry will fail unless generated by a real WebAuthn client.
